...
export default function Footer({ t }: FooterProps) {
  const identity = t.profile.identity;

  return (
    <footer className="footer">
      <div className="footer-identity">
        <a href={`mailto:${identity.email}`} className="footer-link">
        ...
        <a href={identity.orcidUrl} target="_blank" rel="noopener noreferrer" className="footer-link">
          <svg width="16" height="16" viewBox="0 0 256 256" fill="none">
            ...
            <path d="M108.9,79.1h41.6c39.6,0,57,28.3,57,53.6c0,27.5-21.5,53.6-56.8,53.6h-41.8V79.1z M124.3,172.4h24.5c34.9,0,42.9-26.5,42.9-39.7c0-21.5-13.7-39.7-41.4-39.7h-26V172.4z" fill="#fff"/>
