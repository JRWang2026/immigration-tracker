# SEEK NZ 岗位扫描报告 - 2026-08-06 (绿名单Tier1聚焦版)

> 📅 扫描时间：2026-08-06 08:15 | 📧 来源：QQ邮箱SEEK推送（4封邮件：8/5 Admin + 8/5 ICT×2 + 8/5 NZ General）
...
| 🏆最佳匹配 | SRE / DevOps Engineer - Kafka & Confluent (Azure) Data & Platform (Walker Smith) 85分 |
| 绿名单Tier1 | 1 |
| 绿名单Tier2 | 1 |
| 高匹配(60+) | 1 |
| 中匹配(40-59) | 0 |
...
### 1. ⭐ SRE / DevOps Engineer - Kafka & Confluent (Azure) Data & Platform | Walker Smith
| 字段 | 详情 |
|------|------|
| **匹配度** | **85分** 🔥 |
...
| **薪资** | 未公布 |
| **发布日期** | 近期 |
| **匹配分析** | 绿名单Tier1: DevOps/SRE (ANZSCO 261313)；ICT/科技公司；编程/云计算技能；高级数据技能 |
| **所需补充** | 1)英文简历突出具体技术栈(Python/SQL/Cloud/Kafka/Azure)；2)GitHub作品集；3)准备NZ本地面试题；4)NZQA IQA学历评估 |
| **移民关联** | 绿名单Tier1 Straight to Residence | 261313 (Software Engineer) - DevOps/SRE — 有offer即可直申居留 |
...
| # | 职位 | 公司 | 地点 | 薪资 | 匹配度 | 原因 |
|---|------|------|------|------|--------|------|
| 2 | Associate Data Engineer (Power BI) (9-months Fixed Term Contract) | Douglas | Henderson, Auckland | Market related salary + benefits | 38 | 非绿名单:Data Analyst/Engineer(已降级)；ICT/科技公司 |
| 3 | Archival Systems Analyst (MIP) | Fulton Hogan | Christchurch, Canterbury | 未公布 | 38 | 绿名单Tier2: ICT Support/Network/Systems Analyst；非奥克兰地区加分 |
...
| 职位 | 公司 | 首次出现 | 本轮匹配度 | 状态 |
|------|------|----------|-----------|------|
| SRE / DevOps Engineer | Walker Smith | 2026-08-04 | 85 | 绿名单Tier1 DevOps/SRE（持续） |
...
*报告由SEEK NZ自动化扫描生成（绿名单Tier1聚焦版） | 下次扫描：2026-08-07*
