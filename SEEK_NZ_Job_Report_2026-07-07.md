# SEEK NZ 岗位扫描报告 - 2026-07-07 (绿名单Tier1聚焦版)

> 📅 扫描时间：2026-07-07 07:59 | 📧 来源：QQ邮箱 IMAP 直接拉取（10封 SEEK 推送）
...
| 指标 | 数值 |
|------|------|
| 扫描邮件数 | 10（最近3天 SEEK Job Alerts） |
| 去重岗位总数 | 118 |
| 过滤后相关岗位 | 2（仅显示≥35分） |
| 过滤掉岗位 | 116（BSA/Data Analyst/行政等非绿名单岗） |
| 🏆最佳匹配 | HR Systems Administrator (Ministry of Foreign Affairs & Trade) 65分 |
| 绿名单Tier1 | 1 |
| 绿名单Tier2 | 1 |
| 高匹配(60+) | 1 |
| 中匹配(40-59) | 1 |
...
### 1. ⭐HR Systems Administrator | Ministry of Foreign Affairs & Trade
| 字段 | 详情 |
|------|------|
| **匹配度** | **65分** 🔥 |
| **地点** | Unknown |
| **薪资** | 未公布 |
| **发布日期** | 近期 |
| **匹配分析** | 绿名单Tier1: Systems Administrator；政府/公共部门 |
| **所需补充** | 1)英文简历突出具体技术栈(Python/SQL/Cloud/Security)；2)GitHub作品集；3)准备NZ本地面试题；4)NZQA IQA学历评估 |
| **移民关联** | 绿名单Tier1 Straight to Residence | 262113 Systems Administrator — 有offer即可直申居留 |
...
|---|------|------|------|------|--------|-----------|
| 2 | Laser Tag ICT Support | Delta Strike International Ltd | Christchurch Central, Canterbury | $27 – $40 per hour | 50 | 绿名单Tier2: ICT Support/Network/Systems Analyst；ICT/科技公司；非奥克兰地区加分 |
...
### 主线不变：德国岗位制博士（90%精力）
- SEEK NZ 绿名单Tier1 ICT 岗位稀缺，本轮仅 1 个
...
*报告由SEEK NZ自动化扫描生成（绿名单Tier1聚焦版） | 下次扫描：2026-07-08*
