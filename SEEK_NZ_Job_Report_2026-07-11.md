# SEEK NZ 岗位扫描报告 - 2026-07-11 (绿名单Tier1聚焦版)

> 📅 扫描时间：2026-07-11 09:24 | 📧 来源：QQ邮箱SEEK推送（9封邮件，2026-07-08 – 2026-07-11）
...
| 指标 | 数值 |
|------|------|
| 扫描邮件数 | 9（覆盖 2026-07-08 – 2026-07-11） |
| 去重岗位总数 | 93 |
| 过滤后相关岗位 | 0（仅显示≥35分） |
| 过滤掉岗位 | 93（BSA/Data Analyst/行政等非绿名单岗） |
| 🏆最佳匹配 | 无 (-) -分 |
| 绿名单Tier1 | 0 |
| 绿名单Tier2 | 0 |
| 高匹配(60+) | 0 |
...
*报告由SEEK NZ自动化扫描生成（绿名单Tier1聚焦版） | 下次扫描：2026-07-12*
